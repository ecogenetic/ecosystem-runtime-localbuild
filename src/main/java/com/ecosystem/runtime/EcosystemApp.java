...
public class EcosystemApp extends WebSecurityConfigurerAdapter {
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				"ecosystem.Ai Runtime API",
				"The ecosystem.Ai Runtime Engine brings the power of real-time and near-time predictions to the enterprise. Implement your behavioral construct " +
