...
import static org.springframework.web.bind.annotation.RequestMethod.PUT;
	...
	public class ProductMaster {
		...
		@RequestMapping(value = "/processBatch", method = RequestMethod.GET)
		public String processBatch(@RequestHeader Map<String, String> headers,
								   @RequestParam(value = "params", defaultValue = "", required = false) String params) throws Exception {
		 ...
		 * @return Result
		 */
		@ApiOperation(value = "Update response based on recommendation accepted:" +
		...
		@ApiOperation(value = "Provide eStore offers that form part of a campaign for particular customer.")
		@ApiResponse(code = 200, message = "Recommender successfully completed")
		@RequestMapping(value = "/connectU", method = GET)
		public String connectU(  @RequestHeader Map<String, String> headers,
								 @RequestParam(value = "msisdn", defaultValue = "") String customer,
								 @RequestParam(value = "payment_method", defaultValue = "") String paymentMethod,
								 @RequestParam(value = "campaign_id", defaultValue = "") String campaign,
								 @RequestParam(value = "sub_campaign_id", defaultValue = "", required = false) String subcampaign,
								 ...
								 @RequestParam(value = "user_id", defaultValue = "") String userid,
								 @RequestParam(value = "params", defaultValue = "", required = false) String jsonParams) throws Exception {
			LOGGER.info("/connectU API");

			JSONObject paramsParams = new JSONObject();
			try {
				paramsParams = new JSONObject(JSONDecode.decode(jsonParams));
			} catch (org.json.JSONException e) {
				LOGGER.info("/connectU malformed params JSON input: " + jsonParams);
				return paramsParams.put("ErrorMessage", e).toString().intern();
			}
		...
		@ApiOperation(value = "Update eStore offers taken up by customers. Supported response format:" +
				"{\"uuid\":\"dcb54a23-0737-4768-845d-48162598c0f7\",\"offers_accepted\":[{\"offer_treatment_code\":\"GSM_999_A\"}],\"channel_name\":\"USSD\",\"transaction_id\":\"uuid:0aa9140a-755e-48de-84a2-0a67451804f7\"}")
		@RequestMapping(value = "/connectU", method = PUT)
		public String connectU(@RequestHeader Map<String, String> headers,
							   @RequestParam(value = "document", defaultValue = "") String documentJSON) throws IOException, ParseException {
			LOGGER.info("/connectU PUT API");
			String response = ecosystemResponse.putResponse(JSONDecode.decode(documentJSON));
			if (response == null)
				LOGGER.error("/connectU PUT API input document: " + documentJSON);
			else
				LOGGER.info("/connectU PUT API response: " + response);
			return response;
		}
		 ...
		 * @return Result
		 */
		@ApiOperation(value = "Provide gsm offers that form part of a campaign for a particular customer.")
		@ApiResponse(code = 200, message = "Recommender successfully completed")
		 ...
		 * @return Result
		 */
		@ApiOperation(value = "Provide giftRecommendationsFree that form part of a campaign for particular customer.")
		@ApiResponse(code = 200, message = "giftRecommendationsFree successfully completed")
		@RequestMapping(value = "/giftRecommendationsFree", method = GET)
		public String giftRecommendationsFree(@RequestHeader Map<String, String> headers,
												@RequestParam(value = "msisdn", defaultValue = "") String customer,
												@RequestParam(value = "payment_method", defaultValue = "") String paymentMethod,
												@RequestParam(value = "campaign_id", defaultValue = "") String campaign,
												@RequestParam(value = "sub_campaign_id", defaultValue = "", required = false) String subcampaign,
												...
												@RequestParam(value = "number_of_offers", defaultValue = "", required = false) int numberoffers,
												@RequestParam(value = "user_id", defaultValue = "") String userid,
												@RequestParam(value = "params", defaultValue = "", required = false) String jsonParams,
												@RequestParam(value = "transaction_id", defaultValue = "", required = false) String transactionId
		) throws Exception {
			return getRecommendations( customer, paymentMethod, campaign, subcampaign, channel,  numberoffers, userid, jsonParams, transactionId);
		}


		/**
		 * Update giftRecommendationsFree taken up by customers/msisdn.
		 *
		 * @param documentJSON documentJSON
		 * @return Result
		 */
		@ApiOperation(value = "Update giftRecommendationsFree taken up by customers")
		@RequestMapping(value = "/giftRecommendations", method = PUT)
		public String giftRecommendations(@RequestParam(value = "document", defaultValue = "") String documentJSON) throws IOException, ParseException {
			LOGGER.info("/giftRecommendations PUT API");
			String response = ecosystemResponse.putResponse(JSONDecode.decode(documentJSON));
			return response;
		}
		 ...
		 * @return Result
		 */
		@ApiOperation(value = "Provide giftRecommendationsPurchased that form part of a campaign for particular customer.")
		@ApiResponse(code = 200, message = "giftRecommendationsPurchased successfully completed")
		@RequestMapping(value = "/giftRecommendationsPurchased", method = GET)
		public String giftRecommendationsPurchased(@RequestHeader Map<String, String> headers,
													@RequestParam(value = "msisdn", defaultValue = "") String customer,
													@RequestParam(value = "payment_method", defaultValue = "") String paymentMethod,
													@RequestParam(value = "campaign_id", defaultValue = "") String campaign,
													@RequestParam(value = "sub_campaign_id", defaultValue = "", required = false) String subcampaign,
		...
		/**
		 * Update estoreRecommenderNonGSM taken up by customers/msisdn.
		 *
		 * @return Result
		 */
		@ApiResponse(code = 200, message = "Recommender successfully completed")
		@ApiOperation(value = "Update estoreRecommenderNonGSM taken up by customers")
		@RequestMapping(value = "/estoreRecommenderNonGSM", method = GET)
		public String estoreRecommenderNonGSM(@RequestHeader Map<String, String> headers,
											  @RequestParam(value = "msisdn", defaultValue = "") String customer,
											  @RequestParam(value = "payment_method", defaultValue = "") String paymentMethod,
											  @RequestParam(value = "campaign_id", defaultValue = "") String campaign,
											  @RequestParam(value = "sub_campaign_id", defaultValue = "", required = false) String subcampaign,
											  ...
											  @RequestParam(value = "user_id", defaultValue = "") String userid,
											  @RequestParam(value = "params", defaultValue = "", required = false) String jsonParams) throws Exception {
			LOGGER.info("/estoreRecommenderNonGSM API");

			JSONObject paramsParams = new JSONObject();
			try {
				paramsParams = new JSONObject(JSONDecode.decode(jsonParams));
			} catch (org.json.JSONException e) {
				LOGGER.info("/estoreRecommenderNonGSM malformed params JSON input: " + jsonParams);
				return paramsParams.put("ErrorMessage", e).toString().intern();
			}
			...
			try {
				result.put("customer_segment", ((JSONObject) predictResult.get("predict_result")).getString("customer_segment"));
			} catch (Exception e) {
				result.put("customer_segment", "None");
			}
			result.put("customer_segment_default_ratio", ((JSONObject) predictResult.get("predict_result")).get("customer_segment_default_ratio"));
			result.put("vodabuck_conversion_rate", ((JSONObject) predictResult.get("predict_result")).get("vodabuck_conversion_rate"));
		 ...
		 * @return Result
		 */
		@ApiOperation(value = "Update estoreRecommenderNonGSM offers taken up by customers. Supported response format:" +
				"{\"uuid\":\"dcb54a23-0737-4768-845d-48162598c0f7\",\"offers_accepted\":[{\"offer_treatment_code\":\"GSM_999_A\"}],\"channel_name\":\"USSD\",\"transaction_id\":\"uuid:0aa9140a-755e-48de-84a2-0a67451804f7\"}")
		@RequestMapping(value = "/estoreRecommenderNonGSM", method = PUT)
		public String estoreRecommenderNonGSM(@RequestHeader Map<String, String> headers,
											  @RequestParam(value = "document", defaultValue = "") String documentJSON) throws IOException, ParseException {
			LOGGER.info("/estoreRecommenderNonGSM PUT API");
			String response = ecosystemResponse.putResponse(JSONDecode.decode(documentJSON));
			if (response == null)
				LOGGER.error("/estoreRecommenderNonGSM PUT API input document: " + documentJSON);
			else
				LOGGER.info("/estoreRecommenderNonGSM PUT API response: " + response);
			return response;
		}
